...
public class RentalServiceImpl implements RentalService {
    ...
    public RentalServiceImpl(ClientRepositoryPort clientRepositoryPort, SportsFacilityRepositoryPort sportsFacilityRepositoryPort, RentalRepositoryPort rentalRepositoryPort){
    ...
    public Rental rentFacility(String clientId, String facilityId, LocalDateTime startTime, LocalDateTime endTime) throws RentalException {
        ...
        Client client = clientRepositoryPort.findById(clientId)
                .orElseThrow(() -> new ResourceNotFoundException("Klient o ID: " + clientId + " nie istnieje w RentService."));

        SportsFacility sportsFacility = sportsFacilityRepositoryPort.findById(facilityId)
