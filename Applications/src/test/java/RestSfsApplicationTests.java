...
class RestSfsApplicationTests {
    ...
    void shouldCreateFacilityManager() {
        ...
        String newId = given()
                .contentType(ContentType.JSON).body(managerJson)
                .when().post("/api/v1/facility-managers")
                .then().statusCode(201).extract().path("id");

        given()
                .when().get("/api/v1/users/{id}", newId)
                .then().statusCode(200)
    ...
    void shouldUpdateFacilityManager() {
        ...
        """;
        String id = given()
                .contentType(ContentType.JSON).body(createJson)
                .when().post("/api/v1/facility-managers")
                .then().statusCode(201).extract().path("id");
        ...
        given()
                .contentType(ContentType.JSON).body(updateJson)
                .when().put("/api/v1/users/{id}", id)
                .then().statusCode(200);
    ...
    void shouldReturn400OnUserSyntaxViolation() {
        ...
        given()
                .contentType(ContentType.JSON).body(badUserJson)
    ...
    void shouldCreateGym() {
        ...
        String newFacilityId = given()
                .contentType(ContentType.JSON).body(facilityJson)
        ...
        given()
                .when().get("/api/v1/facilities/{id}", newFacilityId)
                .then().statusCode(200)
    ...
    void shouldUpdateGym() {
        String createJson = """
            { "name": "Siłownia Stara", "pricePerHour": 50.0, "capacity": 30, "areaInSqm": 150, "hasSauna": false }
        """;
        String id = given()
                .contentType(ContentType.JSON).body(createJson)
                .when().post("/api/v1/facilities/gyms")
        ...
        String updateJson = """
            { "name": "Siłownia Nowa", "pricePerHour": 55.0, "capacity": 35, "areaInSqm": 150, "hasSauna": true }
        """;

        given()
                .contentType(ContentType.JSON).body(updateJson)
                .when().put("/api/v1/facilities/gyms/{id}", id)
                .then().statusCode(200);

        given()
                .when().get("/api/v1/facilities/{id}", id)
                .then().statusCode(200)
    ...
    void shouldDeleteGym() {
        String createJson = """
            { "name": "Siłownia Usuwana", "pricePerHour": 40.0, "capacity": 20, "areaInSqm": 100, "hasSauna": false }
        """;
        String id = given()
                .contentType(ContentType.JSON).body(createJson)
                .when().post("/api/v1/facilities/gyms")
        ...
        given()
                .when().delete("/api/v1/facilities/{id}", id)
                .then().statusCode(200);
    ...
    void shouldReturn400OnFacilitySyntaxViolation() {
        ...
        given()
                .contentType(ContentType.JSON).body(badFacilityJson)
                .when().post("/api/v1/facilities/gyms")
                .then().statusCode(400);
    }
    ...
    void shouldCreateAllocation() {
        ...
        String clientId = given()
                .contentType(ContentType.JSON).body(clientJson)
                .when().post("/api/v1/clients")
                .then().statusCode(201).extract().path("id");
        ...
        String rentalId = given()
                .contentType(ContentType.JSON).body(rentalJson)
                .when().post("/api/v1/rentals/rent")
                .then().statusCode(200)
        ...
        given()
                .when().get("/api/v1/rentals/client/{clientId}", clientId)
                .then().statusCode(200)
